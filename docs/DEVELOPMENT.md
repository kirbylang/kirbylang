...
- [`src/main.c`](../src/main.c) CLI: REPL, Run \*.krb files
...
- `src/version.c` Defines `KIRBY_VERSION` from `VERSION.txt`. Generated by [`scripts/generate_version_c.sh`](../scripts/generate_version_c.sh) when the project builds. This file is not tracked in source control.
